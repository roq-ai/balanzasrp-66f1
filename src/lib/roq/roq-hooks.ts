...
export function useCerealFindMany<
...
>(
  ...
  const key = JSON.stringify(['useCerealFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cereal.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCerealCount<T extends Prisma.cerealCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.cerealCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useCerealCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cereal.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCerealFindManyWithCount<
  T extends Prisma.cerealFindManyArgs,
  R extends { data: GetFindResult<Prisma.$cerealPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.cerealFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCerealFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cereal.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useCerealFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useCerealFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.cereal.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useProductorFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useProductorFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.productor.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useProductorCount<T extends Prisma.productorCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.productorCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useProductorCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.productor.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useProductorFindManyWithCount<
  T extends Prisma.productorFindManyArgs,
  R extends { data: GetFindResult<Prisma.$productorPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.productorFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useProductorFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.productor.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useProductorFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useProductorFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.productor.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTransportistaFindMany<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTransportistaFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.transportista.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTransportistaCount<T extends Prisma.transportistaCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.transportistaCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useTransportistaCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.transportista.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTransportistaFindManyWithCount<
  T extends Prisma.transportistaFindManyArgs,
  R extends { data: GetFindResult<Prisma.$transportistaPayload<DefaultArgs>, T>[]; count: number },
>(
  args?: Prisma.SelectSubset<T, Prisma.transportistaFindManyArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTransportistaFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.transportista.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useTransportistaFindFirst<
...
>(
  ...
  const roq = useRoqClient();
  const key = JSON.stringify(['useTransportistaFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.transportista.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
