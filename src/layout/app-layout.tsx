...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'data-entry-clerk', 'system-administrator'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Cereals', path: '/cereals', entity: 'cereal', service: AccessServiceEnum.PROJECT, icon: FiCoffee },
    {
      name: 'Productors',
      path: '/productors',
      entity: 'productor',
