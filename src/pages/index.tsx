...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`BalanzaSRP`}</title>

        <meta
          name="description"
          content="Empowering Cereal Producers with BalanzaSRP: Track, Record, and Manage Your Harvest Weights and Movements for a Profitable Harvest Season"
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1471268762677-cb5179779bfe?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxjZXJlYWwlMjBoYXJ2ZXN0fGVufDB8fHx8MTY5OTMwNzI1Mnww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@ejleusink?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Erik-Jan Leusink`}</Link>{' '}
              on{' '}
              <Link
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Cereal Producers with BalanzaSRP: Track, Record, and Manage Your Harvest Weights and Movements for a Profitable Harvest Season`}
            </Text>
            <Box
